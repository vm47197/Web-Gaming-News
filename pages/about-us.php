	...
	<div id="wrapper" style="width: 90em ;padding: 0em 0em 2em 0em">
		<header id="header" class="alt scnd-header"
			...
			<ul style="list-style: none;">
				...
				<li>-Write blogs, reviews and articles on continuing updates or other news on games and gaming companies
				</li>
		...
		<section class="main items">
			<article class="item first-items">
				...
				<ul class="actions">
					<p style="margin-bottom:4%"><b>Manager: Gjylasfije Pulti </b>is the founder and manager of
						Web-Gaming-News.Her love for technology
						started at
						an early age,later
			...
			<article class="item first-items">
				...
				<ul class="actions">
					<p style="margin-bottom:4%"><b>Article Writer: Retila Ramadani</b> is a young succesful woman who
						graduated computer science and english.She is
						the
			...
			<article class="item first-items">
				...
				<ul class="actions">
					<p style="margin-bottom:4%"><b>Manager: Valon Marku</b> is the co-founder and manager of
						Web-Gaming-News.He mostly manages the
