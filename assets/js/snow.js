//IMPORTED. NOT OWNED ORIGINALY-vm47197//
...
var snowStorm = (function (window, document) {
  ...
  if (getCheckedValue != null) {
    ...
    function CheckValue() {
      if (getCheckedValue.checked == false) {
        storm.stop();
      } else {
        storm.resume();
      }
    }
    var getMedia = window.matchMedia("(min-width: 700px)");
  ...
  this.excludeMobile = null;       // Snow is likely to be bad news for mobile phones' CPUs (and batteries.) Enable at your own risk.
  ...
  this.targetElement = document.body;       // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
  ...
  this.zIndex = 1100;                 // CSS stacking order applied to each snowflake
  ...
  var storm = this,
    ...
    windMultiplier = 2,
    flakeTypes = 6,
    fixedForEverything = true, ////HERE CHANGED FALSE >> TRUE
  ...
  if (storm.autoStart) {
    storm.events.add(window, 'load', doStart, true);
  }
